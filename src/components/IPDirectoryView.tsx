...
import { IPAddress, IPStatus, SegmentType } from '../types/ipam';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-white dark:text-white flex items-center gap-2.5">
            ...
            IP Address Directory & Host Inventory
          </h1>
          <p className="text-xs text-slate-400 mt-1 font-mono">
            Real-time IP assignments, hostname bindings, status flags, and subnet allocations.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-amber-500/10 text-amber-400 border border-amber-500/20 hover:bg-amber-500/20 transition-all flex items-center gap-1.5 active:scale-95"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg text-xs font-semibold bg-purple-500/10 text-purple-400 border border-purple-500/20 hover:bg-purple-500/20 transition-all flex items-center gap-1.5 active:scale-95"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 font-mono">
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-2.5 py-1.5 rounded-lg text-xs font-medium border focus:outline-none focus:ring-1 focus:ring-indigo-500 ${
          ...
          <div>
            ...
            >
              ...
              {subnets.map(sub => (
                <option key={sub.id} value={sub.id}>{sub.cidr}</option>
              ))}
            </select>
          </div>
